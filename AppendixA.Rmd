...
# Appendix A: R Code for Implementation of COCo CRaFt 
# (Characterization of Organic Compounds through 
# Chromatography-MS and Random Forest Modeling)
...
This process is repeated for the dataset of unknown compounds, as the data sets must be identically formatted for the property prediction to proceed smoothly
...
Next, we use 5-fold cross validation to identify the optimal number of features for reature restriction in creating diverse trees, identify the optimal model, predict the properties for the test set, and evaluate prediction performance
```{r}
...
# clear here that the prediction/unknown data set lies within the bounds of the training data set, ok to proceed
